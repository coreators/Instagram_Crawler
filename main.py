...
from instagram_crawler.extract_data import crawling_instagram, crawling_profile_src
...
def instagram_profile_src():
    args = get_arguments2()
    is_file_save = crawling_profile_src(args=args)
